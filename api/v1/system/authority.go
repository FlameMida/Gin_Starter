...
func (a *Authority) CreateAuthority(c *gin.Context) {
...
func (a *Authority) CopyAuthority(c *gin.Context) {
...
func (a *Authority) DeleteAuthority(c *gin.Context) {
	var authority system.Authority
	_ = c.ShouldBindJSON(&authority)
...
func (a *Authority) UpdateAuthority(c *gin.Context) {
...
func (a *Authority) GetAuthorityList(c *gin.Context) {
...
func (a *Authority) SetDataAuthority(c *gin.Context) {
	var auth system.Authority
	_ = c.ShouldBindJSON(&auth)
